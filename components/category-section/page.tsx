...
// Corrected import path using relative path (up one level)
...
export default function CategorySection({ categories }: { categories: Category[] }) {
  return (
    <section className="py-12 md:py-16 text-center">
      ...
      {/* View More Button */}
      <div className="mt-12">
        <Link href="/categories" className="inline-flex items-center px-6 py-3 border border-border text-foreground font-medium rounded-lg hover:bg-muted transition">
